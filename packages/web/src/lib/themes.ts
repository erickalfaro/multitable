...
export const BUILTIN_ZEN: Theme = {
  ...
  colors: {
    ...
    // Accent = Lavender from the project hue ring. Chroma bumped from 0.10
    // to 0.16 for a more vivid, recognizable accent across hover states,
    // focus rings, drop placeholders, etc.
    accentBlue: 'oklch(74% 0.16 285)',
    selectionBorder: 'oklch(74% 0.16 285)',
    statusRunning: 'oklch(76% 0.18 160)',
    statusIdle: 'oklch(60% 0.02 280)',
    statusWarning: 'oklch(78% 0.17 70)',
    statusError: 'oklch(70% 0.20 25)',
    ...
    // Chroma 0.13 — bumped from 0.08 alongside the overall vividness lift;
    // still slightly under projects so they don't fight workspace identity.
    catTurn: 'oklch(74% 0.13 298)',
    catTool: 'oklch(74% 0.13 268)',
    catPermission: 'oklch(74% 0.16 30)',
    catElicitation: 'oklch(74% 0.13 233)',
    catRateLimit: 'oklch(74% 0.16 350)',
    catAuth: 'oklch(74% 0.13 178)',
    catTask: 'oklch(74% 0.13 88)',
    catCompaction: 'oklch(74% 0.13 58)',
    catSync: 'oklch(74% 0.13 148)',
    catBudget: 'oklch(74% 0.16 12)',
...
export const BUILTIN_ZEN_LIGHT: Theme = {
  ...
  colors: {
    ...
    accentBlue: 'oklch(48% 0.20 285)',
    selectionBorder: 'oklch(48% 0.20 285)',
    statusRunning: 'oklch(50% 0.22 160)',
    statusIdle: 'oklch(55% 0.02 280)',
    statusWarning: 'oklch(55% 0.20 60)',
    statusError: 'oklch(52% 0.24 25)',
    statusStopped: 'oklch(72% 0.01 280)',
    catTurn: 'oklch(48% 0.17 298)',
    catTool: 'oklch(48% 0.17 268)',
    catPermission: 'oklch(48% 0.20 30)',
    catElicitation: 'oklch(48% 0.17 233)',
    catRateLimit: 'oklch(48% 0.20 350)',
    catAuth: 'oklch(48% 0.17 178)',
    catTask: 'oklch(48% 0.17 88)',
    catCompaction: 'oklch(48% 0.17 58)',
    catSync: 'oklch(48% 0.17 148)',
    catBudget: 'oklch(48% 0.20 12)',
