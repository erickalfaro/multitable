 ...
 * this module owns the per-category icon + tint and the per-severity border
 ...
 * severity continues to drive border / chime so the established red-error,
 * green-success urgency vocabulary survives.
 */
...
export const SEVERITY_BORDER_VAR: Record<AlertSeverity, string> = {
